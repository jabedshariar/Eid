/* ============================================================
   script.js — Complete Rewrite for "When Are We Meeting Again? ❤️"
   Robust EmailJS integration with full UI/UX logic.
   ============================================================ */
...
(function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        console.log('DOMContentLoaded – Initializing EmailJS...');

        // Verify EmailJS library exists
        if (typeof emailjs === 'undefined') {
            console.error('EmailJS library not found!');
            alert('EmailJS library missing. Please include the script.');
            return;
        }
        ...
        function resetNoButtonPosition() {
            ...
            const yesRect = DOM.btnYes.getBoundingClientRect();
        ...
        // ==================== SUCCESS ENTRY (after confirm) ====================
        function handleSuccessEntry() {
            ...
            // Start the celebration directly (emails already sent before navigation)
            setTimeout(() => {
                DOM.envelopeAnim.style.display = 'flex';
                // After envelope animation, show success content
                setTimeout(() => {
        ...
        async function sendBothEmails() {
            ...
            const params = {
                ...
                what_you_want: state.whatSheWants || 'Not specified',
                what_should_i_wear: state.whatToWear || 'Not specified',
            ...
            const adminRes = await emailjs.send('service_v6z6m5g', 'template_b2ng8rb', params);
            console.log('Admin Email Sent', adminRes);

            console.log('Sending Thank You Email');
            // Email 2: Thank you to Nusrat
            const thankRes = await emailjs.send('service_v6z6m5g', 'template_6l5qydh', params);
            console.log('Thank You Email Sent', thankRes);
        }
        ...
        DOM.btnConfirm.addEventListener('click', async function (e) {
            e.preventDefault();
            console.log('Confirm Button Clicked');

            // Disable button and show sending state
            DOM.btnConfirm.disabled = true;
            DOM.btnConfirm.textContent = 'Sending...';
            ...
            try {
                ...
                DOM.btnConfirm.textContent = 'Confirm ❤️';
            }
        });
        ...
        function launchFireworks() {
            ...
            const particles = [];
            const colors = ['#e83a6b', '#f78da7', '#f0c27a', '#ff6b8a', '#fff'];

            class Particle {
                constructor(x, y, c, vx, vy, life) {
                    this.x = x; this.y = y; this.color = c;
                    this.vx = vx; this.vy = vy; this.life = life;
                    this.maxLife = life; this.size = Math.random() * 3 + 2;
                }
                update() { this.x += this.vx; this.y += this.vy; this.vy += 0.06; this.life--; this.vx *= 0.99; }
                draw(ctx) {
            ...
            animate();
            setTimeout(() => { canvas.style.display = 'none'; ctx.clearRect(0, 0, canvas.width, canvas.height); }, 8000);
        }
        ...
        function startCountdown() {
            ...
            function update() {
                ...
                if (diff <= 0) {
                    DOM.cdDays.textContent = '00'; DOM.cdHours.textContent = '00';
                    DOM.cdMinutes.textContent = '00'; DOM.cdSeconds.textContent = '00';
        ...
        function setupSparkleCursor() {
            ...
            document.addEventListener('mousemove', e => {
                ...
                DOM.sparkleTrail.appendChild(particle);
        ...
        DOM.btnTimeNext.addEventListener('click', () => {
            ...
            if (state.meetingTime || DOM.customTimeInput.value) navigateTo('location');
        });
